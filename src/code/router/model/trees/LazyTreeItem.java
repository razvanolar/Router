package code.router.model.trees;

import code.router.utils.resources.ImageProvider;
import code.router.utils.types.TreeItemType;
...
public class LazyTreeItem extends TreeItem<File> {
  ...
  private void setGraphics() {
    if (canHaveChildren)
      ...
      setGraphic(new ImageView(ImageProvider.genericFile()));
  }
